...
export const metadata: Metadata = {
  ...
  description:
    "bongochoti — bangla choti golpo ও sex video প্ল্যাটফর্ম। ১৮০০+ বাংলা চটি গল্প, ১০০০+ bangla porn video। Free bangla choti kahini, categories, search, archive।",
  alternates: { canonical: `${siteUrl}/about/` },
  robots: { index: true, follow: true },
  openGraph: {
    title: "About bongochoti | Bangla Choti & Sex Video Platform",
    description: "১৮০০+ bangla choti golpo, ১০০০+ bangla sex video। Free, ad-free option, categories, search.",
    url: `${siteUrl}/about/`,
    type: "website",
  },
};
