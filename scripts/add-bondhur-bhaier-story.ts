/**
 * Add story from banglachotikahinii.com:
 * বন্ধুর বিয়েতে ঘটকালি করতে গিয়ে বন্ধুর ভাই এর কাছে চোদা খেলাম
 * Run: npx tsx scripts/add-bondhur-bhaier-story.ts
 */

import { FieldValue } from "firebase-admin/firestore";
import { initFirestore } from "./crawler/saveToFirestore";

const TITLE = "বন্ধুর বিয়েতে ঘটকালি করতে গিয়ে বন্ধুর ভাই এর কাছে চোদা খেলাম";
...
async function main() {
  ...
  const id = `bondhur-bhaier-kache-${Date.now().toString(36)}`;
  ...
  await col.doc(id).set({
    ...
    tags: ["গুদ মারা", "পরকিয়া চুদাচুদির গল্প", "বাংলা চটি গল্প", "হট বাংলা চটি"],
  ...
  console.log("Cover: /story_cover/sompa-cover.png. Publish via Admin → Edit Stories when ready.");
}
